...
if(isset($_POST['nombre'])){
    ...
    $horaComienzo = $hora;
    $dbini = "INSERT INTO mesa(pedido, horainicio, timestamp, cantidad) VALUES ('$nombre','$horaComienzo','$timestamp','$cantidad')";
...
if(isset($_POST['horafinal'])){
    $horafinal = $hora;
    $dbfin = "INSERT INTO mesa(horafin, timestamp) VALUES ('$horafinal','$timestamp')";
