...
if(isset($_POST['nombre'])){
    ...
    $horaComienzo = $hora;
    $dbini = "INSERT INTO aromasCafeMesa3(pedido, horainicio, timestamp, cantidad) VALUES ('$nombre','$horaComienzo','$timestamp','$cantidad')";
...
if(isset($_POST['horafinal'])){
    $horafinal = $hora;
    $dbfin = "INSERT INTO aromasCafeMesa3(horafin, timestamp) VALUES ('$horafinal','$timestamp')";
    $result = mysqli_query($conex,$dbfin);
    if($result){
        echo "pedido mesa 3 hora $horafinal";
    }else{
        echo "error";
    }
}
