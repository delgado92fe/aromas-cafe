...
if(isset($_POST['nombre'])){
    ...
    $horaComienzo = $hora;
    $dbini = "INSERT INTO aromasCafeMesa4(pedido, horainicio, timestamp, cantidad) VALUES ('$nombre','$horaComienzo','$timestamp','$cantidad')";
...
if(isset($_POST['horafinal'])){
    $horafinal = $hora;
    $dbfin = "INSERT INTO aromasCafeMesa4(horafin, timestamp) VALUES ('$horafinal','$timestamp')";
