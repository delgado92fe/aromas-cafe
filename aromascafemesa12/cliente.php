...
if(isset($_POST['nombre'])){
    ...
    $horaComienzo = $hora;
    $dbini = "INSERT INTO aromasCafeMesa12(pedido, horainicio, timestamp, cantidad) VALUES ('$nombre','$horaComienzo','$timestamp','$cantidad')";
...
if(isset($_POST['horafinal'])){
    $horafinal = $hora;
    $dbfin = "INSERT INTO aromasCafeMesa12(horafin, timestamp) VALUES ('$horafinal','$timestamp')";
